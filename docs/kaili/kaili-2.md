...
1. 下载系统所需的ATI显示驱动：
   ...
   ![img](/img/img/2-3-1.jpg)

2. 通过键入下列命令来开始安装：

   `sh amd-driver-installer-12-1-x86.x86_64.run`

   ![img](/img/img/2-3-2.jpg)
...
2. 解除我们打算使用的链接类型的注释，这里是`dynamic_chain`：
   ...
   ![img](/img/img/2-6-1.jpg)

3. 向列表中添加一些代理服务器：

   ![img](/img/img/2-6-2.jpg)
