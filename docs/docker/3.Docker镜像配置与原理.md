...
![](/blog/images/3docker-bootfs-rootfs.png)



为了确定 ubuntu 镜像使用的是 Host 的Kernel内核，我们可以使用**uname -a命令查看内核版本**：

![](/blog/images/3docker-kernel.png)
...
![](/blog/images/3docker-bootfs.png)
...
![](/blog/images/3docker-container1.png)
...
![](/blog/images/3docker-container2.png)
